...
from app.models import Station, PlatformAnalysis, TrackAnalysis, DelayPrediction
...
async def get_impact_metrics(
    ...
    passenger_hours_saved = int((actual_stations * trains_per_day * actual_delay_saved * passengers_per_station) / 60)
    fuel_savings_cr = round((trains_per_day * actual_delay_saved * 365 * 1000) / 10000000, 2)
