  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const response = await apiCall<any>('/delay/predict', {
        ...
        // Mock fallback if auth fails or db is empty
  ...
  return (
    <div className="w-full">
      <main className="flex-grow flex flex-col h-screen overflow-hidden">
        {/* TopNavBar (Shared Components) */}
        <header className="w-full h-16 flex justify-between items-center px-margin-desktop bg-surface dark:bg-surface-container-lowest border-b border-outline-variant dark:border-outline z-40">
          <div className="flex items-center gap-4">
            <h1 className="font-headline-md text-headline-md font-bold text-primary dark:text-primary-fixed-dim">RailSense AI</h1>
            ...
            <div className="relative group">
              ...
              <input className="pl-10 pr-4 py-1.5 bg-surface-container rounded-lg border-none focus:ring-2 focus:ring-primary w-64 font-label-md text-label-md transition-all" placeholder="Search system logs..." type="text"/>
            </div>
          </div>
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4">
              <span className="material-symbols-outlined text-on-surface-variant cursor-pointer hover:bg-surface-container-high transition-colors p-2 rounded-full" data-icon="notifications">notifications</span>
              <span className="material-symbols-outlined text-on-surface-variant cursor-pointer hover:bg-surface-container-high transition-colors p-2 rounded-full" data-icon="settings">settings</span>
              <span className="material-symbols-outlined text-on-surface-variant cursor-pointer hover:bg-surface-container-high transition-colors p-2 rounded-full" data-icon="help">help</span>
            </div>
            <div className="flex items-center gap-3 pl-4 border-l border-outline-variant">
              <div className="w-8 h-8 rounded-full bg-primary-container flex items-center justify-center text-on-primary-container font-bold text-xs">RE</div>
              <span className="font-label-md text-label-md text-on-surface">Engineer Profile</span>
            </div>
          </div>
        </header>
        ...
        <div className="flex flex-grow overflow-hidden">
          ...
          <section className="w-[380px] bg-white border-r border-outline-variant p-6 flex flex-col gap-8 overflow-y-auto">
            {/* Train Search */}
            <div>
